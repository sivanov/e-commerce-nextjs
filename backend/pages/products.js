...
export default function Products () {
    ...
    // run once when we mount our component
    // more detailed example: https://nextjs.org/docs/pages/building-your-application/data-fetching/client-side#client-side-data-fetching-with-useeffect
    useEffect(() => {
